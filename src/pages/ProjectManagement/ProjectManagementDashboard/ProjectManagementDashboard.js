...
import evaluateProject from '../../../assets/ProjectManagementDashboard/evaluateProject.svg';
import sprintManagement from '../../../assets/ProjectManagementDashboard/sprintManagement.svg';

const Header = () => {
    return (
        <div className="text-center mt-5" style={{ fontFamily: "Inter", fontSize: "20px", color: "grey" }}>
            <span className="display-6">Project Management DASHBOARD</span>
        </div>
    )
}
            ...
            <div className="row mt-4">
                ...
                <div className="col-lg-4 p-3">
                    <Link to="/pmlist">
                        <div className="card employeeDashboardCard boderRadiusCards" style={{ height : "18rem" }}>
                            <div className="card-body employeeDashboardCardOne" style={{
                                 backgroundImage: `url(${evaluateProject})`, backgroundSize: "cover", 
                                 backgroundRepeat: 'no-repeat', backgroundOrigin: 'content-box' 
                                 }}>
                            </div>
                        </div>
                    ...
                    <Link to="/adminprojectsdashboard">
                        <div className="card employeeDashboardCard boderRadiusCards" style={{ height : "18rem" }}>
                            <div className="card-body employeeDashboardCardTwo" style={{
                                 backgroundImage: `url(${sprintManagement})`, backgroundSize: "cover", 
                                 backgroundRepeat: 'no-repeat', backgroundOrigin: 'content-box' 
                                 }}>
                            </div>
                        </div>
